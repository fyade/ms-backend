...
export class InterfaceController {
  ...
  @Authorize({
    permission: 'sysManage:interface:selList',
    label: '分页查询接口',
  })
  ...
  @Authorize({
    permission: 'sysManage:interface:ins',
    label: '新增接口',
  })
  ...
  @Authorize({
    permission: 'sysManage:interface:inss',
    label: '批量新增接口',
  })
  ...
  @Authorize({
    permission: 'sysManage:interface:upd',
    label: '修改接口',
  })
  ...
  @Authorize({
    permission: 'sysManage:interface:upds',
    label: '批量修改接口',
  })
